...
namespace P2CNetwork
{
    ...
    public sealed class Server
    {
        ...
        Server()
        {
            publicProfileDict = new Dictionary<Guid, IPublicProfile>();
        ...
        public void Disconnect()
        {
            ...
            {
                mainWindowGUI.Notify("Disconnection. Inside Server.Disconnect()." + Environment.NewLine +
        ...
        public void SendMessage(string message)
        {
            ...
            foreach (var pair in socketDict)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Task.Factory.StartNew(() =>
                    {
                        mainWindowGUI.Notify("EXCEPTION IN Server.SendMessage" + Environment.NewLine +
            ...
            mainWindowGUI.TextChatWindow.AppendText(userAccount.UserNick + ": " + Environment.NewLine +
                                                   mainWindowGUI.TextMessage.Text);
            mainWindowGUI.TextMessage.Clear();
        }
        ...
        public void ShakeHand(String ipStr)
        {
            ...
            if (IPAddress.TryParse(ipStr, out ipAddress))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Task.Factory.StartNew(() =>
                    {
                        mainWindowGUI.Notify("EXCEPTION IN Server.ShakeHand" + Environment.NewLine +
                                        "Message: " + Environment.NewLine +
                                        ex.Message);
                    });
                    #endregion
        ...
        public void Start()
        {
            ...
            catch (SocketException se)
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    mainWindowGUI.Notify("Socket Exception:" + Environment.NewLine +
        ...
        void CleanUP()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                mainWindowGUI.Notify("Cancellation requsted. Inside Server.CleanUP(). Server exiting");
            });
            #endregion
        }
        ...
        void NewFriend(Package messageData, Socket client)
        {
            ...
            mainWindowGUI.TextFriendsList.AppendText(messageData.user.UserNick + Environment.NewLine);
        }
        ...
        void NewMessage(Package messageData, Socket client)
        {
            ...
            mainWindowGUI.TextChatWindow.AppendText(messageData.user.UserNick + ":" + Environment.NewLine + message);
    ...
    public class ServiceClient
    {
        ...
        public void Start(Action<Package, Socket> LoadingDock)
        {
            ...
            catch (Exception ex)
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    Interactor.Notify("EXCEPTION WHILE SERVICING INCOMING CONNECTION: " + Environment.NewLine +
